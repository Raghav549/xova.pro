  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-xova-elements-item-contentDefault hover:text-xova-elements-item-contentActive hover:bg-xova-elements-item-backgroundActive':
          !selected,
        'bg-xova-elements-item-backgroundAccent text-xova-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-xova-elements-item-backgroundActive text-xova-elements-item-contentDefault': !selected,
        'bg-xova-elements-item-backgroundAccent text-xova-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-xova-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
